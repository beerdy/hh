...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { description: @gallery.description, link: @gallery.link, slave: @gallery.slave, sort: @gallery.sort, title: @gallery.title, url: @gallery.url } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { description: @gallery.description, link: @gallery.link, slave: @gallery.slave, sort: @gallery.sort, title: @gallery.title, url: @gallery.url } }
